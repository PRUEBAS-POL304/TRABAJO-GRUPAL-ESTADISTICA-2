...
```
  ...
  - Para exportar un archivo a formato CSV, 2 opciones:
```{r}
#write.csv(desempleo, "desempleoBM1.csv", row.names = FALSE)
#write.csv2(desempleo, "desempleoBM2.csv", row.names = FALSE)
```
...
ESTA LIMPIEZA DEBEMOS COLOCARLA EN LA `ENTREGA 2.RMD`
Y COMBINAR TODO

ES DECIR, AQUÍ SOLO DEBERIAMOS HACER 
...
# Merging con las variables escogidas
