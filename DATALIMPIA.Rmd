...
desemple=import(data0)

#write.csv(desemple, "desempleoJ.csv", row.names = FALSE)
#write.csv2(desemple, "desempleoJ2.csv", row.names = FALSE)
```


```{r}
library(rio)
desemple1=import("desempleoJ.csv")
desemple2=import("desempleoJ2.csv")
```


```{r}
library(rio)
data1 = "https://github.co+m/luccemhu/TRABAJO-GRUPAL-ESTADISTICA-2/blob/main/dfs_E4/desempleoBM.csv"

desempleo = import(data1)
```
